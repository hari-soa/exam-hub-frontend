      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-5 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <select
                  ...
                  className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm font-medium text-slate-700 outline-none transition-all duration-200 focus:border-blue-500 focus:bg-white focus:shadow-xs cursor-pointer"
              >
          ...
          <div className="overflow-x-auto rounded-xl border border-slate-200">
            <table className="min-w-full divide-y divide-slate-200 text-left">
              ...
              <tr>
                ...
                <th className="px-6 py-3.5">Code du cours</th>
                <th className="px-6 py-3.5">Date</th>
                <th className="px-6 py-3.5">Tentatives</th>
                <th className="px-6 py-3.5">Taux de réussite</th>
              ...
              {filteredExams.map((exam) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 align-middle text-slate-600">{exam.date}</td>
                    <td className="px-6 py-4 align-middle font-medium">{exam.attempts}</td>
                    <td className="px-6 py-4 align-middle">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-semibold text-slate-700">{exam.successRate}%</span>
                      </div>
                    </td>
          ...
          {filteredExams.length === 0 && (
              <div className="mt-5 rounded-xl border border-dashed border-slate-200 bg-slate-50 p-8 text-center text-sm font-medium text-slate-500">
