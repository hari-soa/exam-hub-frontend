...
export default function StudentProfile() {
  ...
  // Appel API backend pour récupérer les informations du profil étudiant
  ...
  return (
    <div className={`min-h-screen bg-slate-50/60 p-8 ${mounted ? 'opacity-100' : 'opacity-0'} transition-opacity duration-300`}>
      <header className="mb-6">
        ...
        <p className="text-sm text-slate-500 mb-6">Consultez vos informations académiques et paramètres de compte</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-base font-semibold text-slate-900">Informations académiques</h3>
          </div>
      ...
      <div className="bg-blue-50/70 border border-blue-100 rounded-xl p-4 flex items-center gap-3 text-blue-800 text-sm">
        ...
        <div>Pour toute modification de vos informations administratives, veuillez contacter l'administration de l'établissement.</div>
      </div>
