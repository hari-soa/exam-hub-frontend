...
export default function StudentExamResult() {
    ...
    return (
        <div className="flex min-h-[400px] items-center justify-center p-8">
          <div className="flex items-center gap-3 text-slate-500">
            ...
            <span>Loading your graded exam...</span>
          </div>
        </div>
    );
  }
    ...
    return (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-200/80 bg-white p-12 text-center shadow-sm">
          ...
          <p className="mt-1 text-sm text-slate-500 max-w-sm">
            No results are available for this exam or the link is invalid.
          </p>
          <Link
              to="/student/results"
              className="mt-6 inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-slate-800 active:scale-95"
          >
  ...
  const examTitle = result.examTitle || result.title || "Exam";
  ...
  const attemptedAt = result.attemptedAt || result.submittedAt
      ? new Date(result.attemptedAt || result.submittedAt).toLocaleString("en-US", { dateStyle: "medium", timeStyle: "short" })
      : "N/A";
  ...
  return (
      <div className="space-y-8 pb-8">
        <div>
          <Link
              to="/student/results"
              className="inline-flex items-center gap-2 text-xs font-semibold text-slate-500 transition hover:text-slate-800 mb-4 active:scale-95"
          >
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-slate-100 bg-slate-50/50 p-4">
                <div className="flex items-center justify-between text-slate-500 mb-1">
                  <span className="text-xs font-semibold uppercase tracking-wider">Percentage</span>
              ...
              <div className="rounded-xl border border-slate-100 bg-slate-50/50 p-4">
                <div className="flex items-center justify-between text-slate-500 mb-1">
                  <span className="text-xs font-semibold uppercase tracking-wider">Date Taken</span>
                  ...
                  <span className="text-xs font-bold uppercase tracking-wider text-slate-400">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      ...
                      >
                        ...
                        <p className="text-sm font-semibold">{selectedOpt || "No answer"}</p>
                      </div>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Link
              to="/student"
              className="rounded-xl bg-blue-600 px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-blue-700 active:scale-95"
          >
            Back to Exams
          </Link>
        </div>
