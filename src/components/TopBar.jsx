        ...
        <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            <div className="relative" ref={searchRef}>
              ...
              {searchOpen && (
                  <div className="absolute -right-12 sm:right-0 z-50 mt-2 w-[calc(100vw-2rem)] max-w-xs sm:w-80 rounded-2xl border border-slate-200 bg-white p-3 shadow-xl">
            ...
            <div className="relative" ref={notifRef}>
              ...
              {notificationsOpen && (
                  <div className="absolute -right-8 sm:right-0 z-50 mt-2 w-[calc(100vw-2rem)] max-w-xs sm:w-80 rounded-2xl border border-slate-200 bg-white p-3 shadow-xl">
